  ...
  return (
    <div className="setup">
      ...
      <section>
        <h2>測定のしかた</h2>
        <ol>
          <li>暗めの部屋で行うと見やすくなります。</li>
          <li>
            画面中央に十字が表示されます。中心が見えづらくても、十字の線の延長が
            交わるあたりを見続けてください。
          </li>
          <li>
            中央のまわり8方向に、切れ目のある白い輪（ランドルト環。視力検査で
            使う「C」のマークです）が最初から表示されています。切れ目の向きは
            輪ごとにバラバラです。そのうち1つずつが順番に、外側に向かって
            ゆっくり動いていきます。視線は中央に向けたまま、
            <strong>
              動いている輪の切れ目がどちらを向いているか分かった瞬間に
              スペースキーを押すか、画面をタップ
            </strong>
            してください。
          </li>
          <li>
            「ぼんやり輪がある」ではなく「切れ目の向きが分かった」タイミングで
            応答するのがポイントです。これを8方向について行います（1〜2分程度）。
            端まで動いても分からなければ、何もしなくてOKです。
          </li>
        </ol>
      </section>
